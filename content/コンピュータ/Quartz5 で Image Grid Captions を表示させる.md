---
subtitle: 画像を2段、3段組みにして、その画像の説明文を入れるには
date: 2026-09-05
modified: 2026-08-29
categories:
  - コンピュータ
...
columns: 2
gap: 16
![[omoya_gDSC04454.jpg|牛ヶ淵の蓮の花（2段組）]]
![[omoya_gDSC04460.jpg|牛ヶ淵の蓮の花（2段組）]]
```
...
Image Captions をインストールすることにより、①キャプションを付けることができ、②画像配置をコントロールする、といったことができる。画像幅は Obsidian 標準と同様に指定できる。
