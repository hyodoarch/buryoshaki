 ...
 * @return void
 */
function init_flux_post(args) {
    print_first_row_post(args);
 ...
 * @return void
 */
function print_first_row_post(args) {
    jQuery.post(
        ajaxurlPost,
        {
            'action': 'mon_action_Post', //action in lib/modules/flux_data/models/ft_postAjax.php
            'query_args': args.query_args,
            'posts_per_page': args.posts_per_page,
            'type': args.type,
            'load_more_is_activated': args.load_more_is_activated,
        ...
        function (response) {
            if (response) {
                jQuery('#row_post_' + args.hash).append(response);
            } else {
...
function load_more_post(args) {
    ...
    jQuery('body').on('change', '.select-number-element', function () {
        ...
        jQuery.post(
            ajaxurlPost,
            {
                'action': 'load_more_post', //action in lib/modules/flux_data/models/ft_postAjax.php
